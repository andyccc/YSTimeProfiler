...
- (UIButton *)expandBtn
{
    if (!_expandBtn) {
        ...
        [_expandBtn setBackgroundImage:[UIImage imageNamed:@"YSNOExpandIcon"] forState:UIControlStateNormal];
        [_expandBtn setBackgroundImage:[UIImage imageNamed:@"YSExpandIcon"] forState:UIControlStateSelected];
